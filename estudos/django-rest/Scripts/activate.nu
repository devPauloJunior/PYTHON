...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Amontada Valley INS\Documents\PYTHON\estudos\django-rest'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Amontada Valley INS\Documents\PYTHON\estudos\django-rest\Scripts\deactivate.nu'
